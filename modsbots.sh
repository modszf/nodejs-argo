...
sleep 5
nohup ./server tunnel --edge-ip-version auto --no-autoupdate --protocol http2 run --token eyJhIjoiNmIwYzRiZDczMjQ4Y2IxNTYyMTdmN2QyNzZlOWE5ZjAiLCJ0IjoiN2JjOWI3ZmQtOTk5OC00YjViLWFmNzYtM2ExZDdiMDg2MmFhIiwicyI6IlpXUmlOVGMxTldFdFlXUXpZeTAwWlRVMExUbGxZV1F0WXpoa1ptVTNOalJsWVRNMCJ9
